...
type OrganizationLanding = Awaited<
  ReturnType<typeof getOrganizationLandingBySlug>
>;
          ...
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button
                ...
                size="lg"
                variant="secondary"
                className="h-14 rounded-xl px-10 font-heading font-semibold text-primary"
              >
                <Link href={appRoutes.courts.base}>Browse Courts</Link>
              </Button>
              {hasVenues && (
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="h-14 rounded-xl border-primary-foreground/30 px-10 font-heading text-primary-foreground hover:bg-primary-foreground/10"
                >
                  <a href="#venues">View Venues</a>
                </Button>
              )}
