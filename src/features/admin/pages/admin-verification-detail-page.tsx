...
import {
  useMutApprovePlaceVerification,
  useMutRejectPlaceVerification,
...
export default function AdminVerificationDetailPage({
  ...
  const { data, isLoading } = useQueryPlaceVerificationRequest(requestId);
  const approveMutation = useMutApprovePlaceVerification();
  const rejectMutation = useMutRejectPlaceVerification();
