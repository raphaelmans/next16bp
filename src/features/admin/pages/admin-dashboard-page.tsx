...
import {
  useQueryAdminRecentActivity,
  useQueryAdminStats,
  useQueryPendingClaims,
...
export default function AdminDashboardPage() {
  ...
  const { data: stats, isLoading: statsLoading } = useQueryAdminStats();
  const { data: pendingClaims = [], isLoading: claimsLoading } =
    useQueryPendingClaims(5);
  const { data: recentActivity = [], isLoading: activityLoading } =
    useQueryAdminRecentActivity(5);
