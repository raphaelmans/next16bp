...
import {
  useMutAdminNotificationDispatchNow,
  useMutAdminNotificationEnqueueClaimReviewedTest,
  useMutAdminNotificationEnqueuePlaceVerificationReviewedTest,
  useMutAdminNotificationEnqueueReservationCreatedTest,
  useMutAdminNotificationEnqueueWebPushTest,
  useQueryAdminNotificationMyWebPushSubscriptions,
...
export default function AdminNotificationTestPage() {
  ...
  const dispatchMutation = useMutAdminNotificationDispatchNow();
  ...
  const webPushSubscriptionsQuery =
    useQueryAdminNotificationMyWebPushSubscriptions();
  const webPushTestMutation = useMutAdminNotificationEnqueueWebPushTest();
