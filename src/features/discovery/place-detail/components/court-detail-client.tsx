...
export default function CourtDetailClient({
  ...
  const dayAvailabilityQuery = useQueryDiscoveryAvailabilityForCourt(
    {
      courtId,
      date: dayViewDateIso ?? "",
    ...
    !isWeekView && !!dayViewDateIso,
  );

  const weekAvailabilityQuery = useQueryDiscoveryAvailabilityForCourtRange(
    {
      courtId,
