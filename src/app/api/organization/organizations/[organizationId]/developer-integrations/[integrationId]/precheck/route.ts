...
import { RunDeveloperPrecheckSchema } from "@/lib/modules/developer-integration/dtos/developer-integration.dto";
...
export async function POST(req: Request, context: { params: Params }) {
  ...
  try {
    ...
    const input = validate(RunDeveloperPrecheckSchema, {
    ...
    const result = await service.runPrecheck(session.userId, input, requestId);
