...
import { ListRowsSchema } from "@/lib/modules/bookings-import/dtos";
...
export async function GET(req: Request, context: { params: Params }) {
  ...
  try {
    ...
    const input = validate(ListRowsSchema, {
      jobId,
    ...
    const result = await service.listRows(session.userId, input);
