...
import {
  GetCourtHoursSchema,
  SetCourtHoursSchema,
} from "@/lib/modules/court-hours/dtos";
import { makeCourtHoursService } from "@/lib/modules/court-hours/factories/court-hours.factory";
...
export async function GET(req: Request, context: { params: Params }) {
  ...
  try {
    ...
    const input = validate(GetCourtHoursSchema, { courtId });
...
export async function PUT(req: Request, context: { params: Params }) {
  ...
  try {
    ...
    const input = validate(SetCourtHoursSchema, {
