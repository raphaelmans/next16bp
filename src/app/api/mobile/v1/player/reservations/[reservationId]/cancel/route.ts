...
import { CancelReservationSchema } from "@/lib/modules/reservation/dtos";
...
type CancelReservationMobileResponse = Awaited<
  ReturnType<IReservationService["cancelReservation"]>
>;
...
export async function POST(req: Request, context: { params: Params }) {
  ...
  try {
    ...
    const input = validate(CancelReservationSchema, {
    ...
    return NextResponse.json<ApiResponse<CancelReservationMobileResponse>>(
      wrapResponse(result),
    );
  } catch (error) {
