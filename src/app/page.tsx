          ...
          <Container>
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
                We&apos;re solving the fragmentation in the pickleball
                community. No more messaging 5 different Facebook pages to find
                an open slot.
              </p>
            </div>
          ...
          <Container>
            <div className="text-center">
              ...
              <p className="mt-4 text-lg text-primary-foreground/80 max-w-xl mx-auto">
                Find available courts near you and book your next game in
                seconds.
              </p>
              <div className="mt-8">
                <Button
