...
export default function CourtPricingPage() {
  ...
  if (orgLoading || courtLoading || rulesLoading) {
    return (
  ...
  return (
    ...
    >
      <div className="space-y-6">
        <PageHeader
          title={`Pricing Rules · ${courtData.court.label}`}
          description="Set hourly pricing by day and time range"
          breadcrumbs={[
          ...
          <CardContent className="p-6 space-y-4">
            ...
            {hasConflicts && (
              <p className="text-sm text-destructive">
                Resolve overlaps before saving pricing rules.
              </p>
            )}
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                type="button"
                onClick={handleSave}
                disabled={saveRules.isPending || hasConflicts}
              >
