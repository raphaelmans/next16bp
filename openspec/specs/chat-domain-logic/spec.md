...
Defines requirements for chat domain logic separation: canonical channel/message identity rules as pure shared functions, view-model shaping in feature-local domain files, and UI components consuming domain outputs.
