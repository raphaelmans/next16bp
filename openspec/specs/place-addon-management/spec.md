...
Define venue-level (GLOBAL) add-on management, storage, and owner workflows so add-ons can be configured once at place scope and inherited across all courts.
