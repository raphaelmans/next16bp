...
Defines requirements for the booking summary and warning UI when add-ons are selected or auto-applied, including transparent price breakdown, non-blocking warning display, and accessible responsive layout.
