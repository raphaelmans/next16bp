# reservation-notification-routing-testing Specification

## Purpose
TBD - created by archiving change tdd-reservation-notification-routing-testing. Update Purpose after archive.
## Requirements
