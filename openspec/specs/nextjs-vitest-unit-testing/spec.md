...
Defines requirements for the Vitest unit-test setup in the Next.js repository, including configuration, environment, test structure conventions, and scope boundaries.
