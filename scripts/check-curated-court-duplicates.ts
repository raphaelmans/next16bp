...
function extractPhoneTokens(value: string | null | undefined): Set<string> {
...
function classifyRow(
  ...
  const key = [
    normalizeLoose(incoming.name),
    normalizeLoose(incoming.city),
    normalizeLoose(incoming.province),
  ].join("|");
